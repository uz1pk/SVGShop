...
int addCircleToSVG(char *fileName, char *schemaFile, float cx, float cy, float r, char *units);
...
int setAttributeInFile(char *fileName, char *schemaFile, char *shape, int index, char *attrName, char *attrValue);
